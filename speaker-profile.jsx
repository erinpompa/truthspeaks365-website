...
const SPEAKERS = {
  ...
  "nicolle-gonzalez": {
    ...
    tagline: "Helping students identify what they're feeling and giving them tools to process, manage, and regulate their emotions.",
    sub: "I help students identify what they're feeling and give them tools to process, manage, and regulate their emotions.",
    color: "var(--orange)",
    ...
    ctaTitle: <span>Bring <HL color="var(--orange)">Nicolle</HL> to your school or event.</span>,
  },
  "erin-pompa": {
    name: "Erin Pompa",
