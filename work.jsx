...
const G68Presenters = () => {
  const presenters = [
    ...
    { name: "Nicolle Gonzalez", role: "Emotions & Resilience Speaker", tagline: "Name it. Stop running. Learn to move through it.", color: "var(--sky)", nameColor: "var(--ink)", img: "/uploads/nicolle-gonzalez.jpg", href: "/speaker-profile?id=nicolle-gonzalez" },
  ];
  return (
    <div>
